...
InvalidOpType, UnexpectedMove, UnexpectedInput, \
UnexpectedCall, FuncTableMem, FuncMem, FuncInputsMem, \
InputMem} ; 
...
" or RT.\n\n"
#define UNEXPECTED_INPUT "\nERROR: %d - Unexpected type of"\
" choice in define_inputs() function.\nShould either be " \
"\"SET\" or \"CALL\".\n\n"
#define UNEXPECTED_CALL "\nERROR: %d - Unexpected type of"\
" choice in check_if_same() function.\nShould either be " \
"\"RETURN\" or \"CALL\".\n\n"
#define FUNC_TABLE_MEM "\nERROR: %d - Unable to allocate " \
"memory for the function hash table.\n\n"
#define FUNC_MEM "\nERROR: %d - Unable to allocate " \
"memory for a function in an element of the hash table.\n\n"
#define FUNC_INPUTS_MEM "\nERROR: %d - Unable to allocate" \
" memory for the array of inputs of a function.\n\n"
#define INPUT_MEM "\nERROR: %d - Unable to allocate " \
"memory for a specific input to a function.\n\n"
...
OffTopScreen, NoMain, TooManyMains, FuncNameVarNum, \
FuncNameForbid, FuncInputOpen, FuncInputClose, \
VarNameForbid, VarSetVar, NoFuncStart, IncorNumInputs, \
NoFuncCallEnd, FuncNotDefined} ; 
...
#define NO_MAIN "\nExtension Error: %d - The input file " \
"does not contain a main function.\nIe, there is no " \
"\"MAIN\" to declare the start of the main function.\n" \
"Error occurred at string: %d.\n\n"
#define TOO_MANY_MAINS "\nExtension Error: %d - The input" \
" file does not contains more than one main function.\n" \
"Ie, \"MAIN\" is declared more than once.\n" \
"Error occurred at string: %d.\n\n"
#define FUNC_NAME_VARNUM "\nExtension Error: %d - Trying " \
"to define a function using either a variable name [A-Z]," \
" or a number.\nNot allowed - try something else.\nError " \
"occurred at string: %d.\n\n"
#define FUNC_NAME_FORBID "\nExtension Error: %d - Trying " \
"to define a function using either a variable name/string" \
" that is already defined in the grammar.\nNot allowed - " \
"try something else.\nError occurred at string: %d.\n\n"
#define FUNC_INPUT_OPEN "\nExtension Error: %d - Trying " \
"to determine inputs to function, however there is no " \
"function input opening characer, ie \"(\".\nError " \
"occurred at string: %d.\n\n"
#define FUNC_INPUT_CLOSE "\nExtension Error: %d - Trying " \
"to determine inputs to function, however there is no " \
"function input closing characer, ie \")\".\nError " \
"occurred at string: %d.\n\n"
#define VAR_NAME_FORBID "\nExtension Error: %d - Trying " \
"to define or set the input to a function as a string" \
" that is already defined in the grammar.\nNot allowed - " \
"try something else.\nError occurred at string: %d.\n\n"
#define VAR_SET_VAR "\nExtension Error: %d - Trying " \
"to define the input to a function as a variable name" \
" (ie, [A-Z]).\nNot allowed - " \
"try something else.\nError occurred at string: %d.\n\n"
#define NO_FUNC_START "\nExtension Error: %d - Expecting " \
"the function call string, ie \"FUNC\" to call a function" \
" from within MAIN.\nError occurred at string: %d.\n\n"
#define INCOR_NUM_INPUTS "\nExtension Error: %d - The " \
"number of inputs put into the function, does not equal " \
"the number of required inputs, as set in the function " \
"definition.\nError occurred at string: %d.\n\n"
#define NO_FUNC_CALL_END "\nExtension Error: %d - " \
"Expecting the function call end symbol, ie \";\" to " \
"signal that a function call has finished.\nError " \
"occurred at string: %d.\n\n"
#define FUNC_NOT_DEFINED "\nExtension Error: %d - " \
"Attempting to call a function that has not been defined " \
"in the input program file.\nPlease check spelling and " \
"ensure that function is defined before calling.\nError " \
"occurred at string: %d.\n\n"
